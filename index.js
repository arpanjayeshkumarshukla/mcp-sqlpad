...
const BASE_URL = process.env.SQLPAD_BASE_URL || "https://sqlpad.postmanlabs-beta.com";
const TOKEN = process.env.SQLPAD_TOKEN;

if (!TOKEN) {
  console.error("SQLPAD_TOKEN env var is not set. Export it (see ~/.zshrc) before launching this server.");
  process.exit(1);
}
